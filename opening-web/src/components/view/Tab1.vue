<template>
  <el-form :model="data" :rules="rules" ref="data" label-width="100px">
    <el-form-item label="标题：" prop="Title">
      <el-input v-model="data.val.Title" placeholder="请输入標題..."/>
    </el-form-item>
    ...
    <el-form-item label="描述：" prop="Description">
      <el-input v-model="data.val.Description" placeholder="请输入描述..."/>
    </el-form-item>
    <el-form-item label="链接：" prop="Url">
      <el-input v-model="data.val.Url" placeholder="请输入链接..."/>
    </el-form-item>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        CREATE,
        data: {type: 'SUBSCRIBE_WECHAT_BACK', val: {}},
        rules: {
